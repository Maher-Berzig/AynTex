...
# VERSION: 3.0.1 — Removed internal scroll area, direct layout like Display Options
# ============================================================================
...
class GraphDrawingPlugin(PlotPlugin):
    """Interactive graph drawing plugin — v3.0.1 (no internal scroll)"""
